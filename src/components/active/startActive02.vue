      ...
      <el-row>
          ...
          <el-col span="15">
            <el-table class="totalTable" size="mini" :data="activeClassTotal" style="width: 90%">
                  ...
                  <el-table-column prop="activeClassName" label="礼品级别"></el-table-column>
                </el-table>
          </el-col>    
      </el-row>
      <br>
...
export default {
  ...
  methods: {
    vaild() {
      ...
      let url = `${this.$store.state.host}api/cuxiao/active/vaildData02`;
      this.$http
        .post(url, {
    ...
    returnMny() {
      ...
      this.$confirm("兑换后无法修改, 是否继续?", "提示", {
        ...
        .then(() => {
          ...
          let url = `${this.$store.state.host}api/cuxiao/active/submit02`;
          this.$http
            .post(url, {
